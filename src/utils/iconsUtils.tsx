...
export const FileXIcon = ({ size }: { size?: number }) => (
  <IconBase size={size}>
...
export const FileOffIcon = ({ size }: { size?: number }) => (
  <IconBase size={size}>
    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
    <polyline points="14 2 14 8 20 8" />
    <line x1="2" y1="2" x2="22" y2="22" />
...
export const FileRestoreIcon = ({ size }: { size?: number }) => (
  <IconBase size={size}>
    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
    <polyline points="14 2 14 8 20 8" />
