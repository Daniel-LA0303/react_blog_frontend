  ...
  return (
    <>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`md:hidden fixed top-0 left-0 right-0 z-[999] px-4 py-5 flex items-center gap-3 border-b
              ${dark
          ...
          >
            ...
            {search.trim() && (
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="flex-shrink-0 rounded-full h-6 w-6 flex items-center justify-center bg-[#2563EB] text-white"
              >
            ...
            <button
              type="button"
              onClick={handleClose}
              className={`flex-shrink-0 transition-colors ${dark ? 'text-gray-500 hover:text-gray-300' : 'text-gray-400 hover:text-gray-600'}`}
            >
      ...
      <div className="flex items-center">
        ...
        {/* Desktop: inline expand in navbar */}
        <AnimatePresence initial={false} mode="wait">
          {isOpen ? (
            <motion.div
              ...
              transition={{ type: 'spring', stiffness: 340, damping: 30 }}
              className={`hidden md:flex items-center gap-2 rounded-full border px-3 py-1.5 overflow-hidden
            ...
            <motion.button
              ...
              transition={{ duration: 0.15 }}
              whileTap={{ scale: 0.9 }}
              className={`hidden md:flex items-center justify-center h-8 w-8 rounded-lg transition-colors
                ${dark ? 'text-gray-400 hover:bg-gray-800 hover:text-gray-200' : 'text-gray-500 hover:bg-gray-100 hover:text-gray-700'}`}
            >
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8}
                strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
