...
const EditReply = ({
    ...
    const handleEditReplyAction = (editReply: any, reply: any) => {
      handleEditReply(editReply, reply);
      setEditReplyActive(!editReplyActive);
    }

  return (
    <div className={` ${globalData.themeGlobal ? ' bgt-light text-black' : 'bgt-dark hover:bg-zinc-700 text-white'} w-full flex mx-auto items-center justify-center shadow-lg my-4 rounded-lg`}>
